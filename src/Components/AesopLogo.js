export default function AesopLogo (){
  return(
    <a class="NavLogo" data-test-ref="NAV_LOGO" href="/hk/en/">
    <svg
      aria-labelledby="c251f58b-0a20-4b9b-be90-f32c7685d2f2"
      class="Icon NavLogo-icon w-50"
      role="img"
      viewBox="0 0 489.7 154.3"
    >
    <title id="c251f58b-0a20-4b9b-be90-f32c7685d2f2">Aesop logo</title>
    <g>
      <path
